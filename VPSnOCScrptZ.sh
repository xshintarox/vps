...
if [[ $vps = "vps" ]]; then
	source="https://raw.githubusercontent.com/xshintarox/vps/master"
else
	source="https://raw.githubusercontent.com/xshintarox/vps/master"
fi
...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/xshintarox/vps/master/sources.list.debian7"
...
echo 'echo -e "Script mod by Shin"' >> .bashrc
echo 'echo -e "Credits to Clrkz"' >> .bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/xshintarox/vps/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Clrkz</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/xshintarox/vps/master/vps.conf"
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/xshintarox/vps/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/xshintarox/vps/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
iptables -t nat -I POSTROUTING -s 192.168.100.0/24 -o eth0 -j MASQUERADE
iptables-save > /etc/iptables_yg_baru_dibikin.conf
wget -O /etc/network/if-up.d/iptables "https://raw.githubusercontent.com/xshintarox/vps/master/iptables"
chmod +x /etc/network/if-up.d/iptables
service openvpn restart

# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/xshintarox/vps/master/client-1194.conf"
sed -i $MYIP2 /etc/openvpn/client.ovpn;
cp client.ovpn /home/vps/public_html/

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/xshintarox/vps/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/xshintarox/vps/master/badvpn-udpgw64"
fi
...
sed -i 's/DROPBEAR_PORT=22/DROPBEAR_PORT=3129/g' /etc/default/dropbear
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/xshintarox/vps/master/squid3.conf"
...
wget https://raw.githubusercontent.com/xshintarox/vps/master/ddos-deflate-master.zip 
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/xshintarox/vps/master/issue.net"
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/xshintarox/vps/master/menu.sh"
wget -O usernew "https://raw.githubusercontent.com/xshintarox/vps/master/usernew.sh"
wget -O trial "https://raw.githubusercontent.com/xshintarox/vps/master/trial.sh"
wget -O delete "https://raw.githubusercontent.com/xshintarox/vps/master/hapus.sh"
wget -O check "https://raw.githubusercontent.com/xshintarox/vps/master/user-login.sh"
wget -O member "https://raw.githubusercontent.com/xshintarox/vps/master/user-list.sh"
wget -O restart "https://raw.githubusercontent.com/xshintarox/vps/master/resvis.sh"
wget -O speedtest "https://raw.githubusercontent.com/xshintarox/vps/master/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/xshintarox/vps/master/info.sh"
wget -O about "https://raw.githubusercontent.com/xshintarox/vps/master/about.sh"
...
echo "Dropbear : 143, 3129"  | tee -a log-install.txt
